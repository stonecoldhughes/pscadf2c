...
def generate_header( params, name ):
...
parser = argparse.ArgumentParser( description = 'Convert FORTRAN code into C++' )

parser.add_argument( '-n', '--name', help = 'name the subroutine', required = True )
...
parser.add_argument( '-d', '--destination', help = 'name of output file', required = True )
...
# Captain! Make sure the csv file does not have any trailing spaces...
size_key = {}
...
header = generate_header( list(params), args.name )
